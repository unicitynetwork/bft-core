...
func Test_generate_TXSTestsData(t *testing.T) {
	...
	fOut := rust.TestFile(t, "tests/txsystem_test.rs", "use ubft::txsystem::TxOrder;")
...
func Test_generateDecoderTests(t *testing.T) {
	...
	fOut := rust.TestFile(t, "tests/decoder_test.rs", "use ubft::decoder::{Decoder, TagValueIter, Value};")
