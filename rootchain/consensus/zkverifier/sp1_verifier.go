...
// The proof includes:
// - Public inputs: previousStateRoot, newStateRoot
// - Proof data: SP1 compressed proof bytes
//
// This function verifies that executing the program with previousStateRoot
// as input produces newStateRoot as output.
func (v *SP1Verifier) VerifyProof(proof []byte, previousStateRoot []byte, newStateRoot []byte) error {
	if !v.enabled {
