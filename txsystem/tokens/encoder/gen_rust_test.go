...
import (
	...
	"github.com/unicitynetwork/bft-core/internal/testutils/rust"
		...
		tests := []utEnc{
			{
				...
				enc: []byte{0x1, 0x1, 0x3, 0x0, 0x0, 0x0, 0x1, 0x5, 0x0, 0x5, 0x2, 0x5a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
			},
			{
				data: &tokens.NonFungibleTokenData{
					TypeID:  []byte{1},
				...
				enc: []byte{0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x1, 0x2, 0x4, 0x9, 0x0, 0x0, 0x0, 0x68, 0x6f, 0x74, 0x20, 0x73, 0x74, 0x75, 0x66, 0x66, 0x3, 0x4, 0x7, 0x0, 0x0, 0x0, 0x66, 0x6f, 0x6f, 0x2f, 0x62, 0x61, 0x72, 0x4, 0x1, 0x3, 0x0, 0x0, 0x0, 0x9, 0x1, 0x1, 0x5, 0x2, 0x5a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
			},
		}
		for n, tc := range tests {
